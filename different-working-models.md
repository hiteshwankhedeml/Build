...
* Don't reinvent the wheel, try to reuse
* Import prebuilt processes and automations from the built in Store
* Build custom processes and automations from scratch using the Process builder tool
